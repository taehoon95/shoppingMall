...
public class productBuyCusInfoPanel extends JPanel implements ChangeListener{
	...
	private void initialize() {
		...
		panel_3.setBorder(new TitledBorder(new EmptyBorder(20, 0, 20, 0), "개인정보", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
